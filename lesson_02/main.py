...
def main():
    ...
    print(res)
    res = count_values(power, 1, 2, 3, 4, 5, 6, as_list=True)
    print(res)
...
def demo_wo_decorators():
    res = time_func(power, 1_000_000, 100)
    print("got res", res)
    res = time_func(power, 1_000_000_000_000_000_000000_000_000)
    print("got res", res)
...
#
# print(new_power(1000000000000000))
# print()
# print(new_div(100, 2))
